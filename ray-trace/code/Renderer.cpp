...
// the normal N
// [/comment]
auto refract(const Vector3f &I, const Vector3f &N, const float &ior)
    -> Vector3f {
...
// [/comment]
auto castRay(const Vector3f &orig, const Vector3f &dir, const Scene &scene,
             int depth) -> Vector3f {
...
void Renderer::Render(const Scene &scene) {
  ...
  for (auto i = 0; i < scene.height * scene.width; ++i) {
    static std::array<unsigned char, 3> color;
