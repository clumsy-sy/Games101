...
auto final_scene() -> hittable_list {
  ...
  auto emat = make_shared<lambertian>(make_shared<image_texture>("build/earthmap.jpg"));
  ...
  objects.add(make_shared<translate>(
      make_shared<rotate_y>(make_shared<bvh_node>(boxes2, 0.0, 1.0), 15), Vec3d(-100, 270, 395)));
